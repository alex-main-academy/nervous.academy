/******/ (function () {
  ...
  \***********************************/
      /***/ function (
        ...
        const openPaySectionButtons =
          document.querySelectorAll(".js-go-to-pay");
        ...
        openPaySectionButtons[0].addEventListener("click", () => {
          sectionIndex = 8;
          changeSection();
          activeMenuItem();
          showButton();
        ...
        openPaySectionButtons[1].addEventListener("click", () => {
          sectionIndex = 8;
          changeSection();
          activeMenuItem();
          showButton();
        ...
        openPaySectionButtons[2].addEventListener("click", () => {
          sectionIndex = 8;
          changeSection();
          activeMenuItem();
          showButton();
